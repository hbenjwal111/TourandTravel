...
import com.extect.appbase.AppEnvironment;
...
public class PayUMainActivity extends com.extect.appbase.BaseActivity implements View.OnClickListener {

    public static final String TAG = "PayUMainActivity : ";
   ...
   /* protected void setupActionbar() {
        getmActionBar().show();
        getmActionBar().setTitle(getResources().getString(R.string.enter_details));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.payumobile_layout);
...
*/
    ...
    private void setupCitrusConfigs() {
        ...
        if (appEnvironment == AppEnvironment.PRODUCTION) {
            Toast.makeText(PayUMainActivity.this, "Environment Set to Production", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(PayUMainActivity.this, "Environment Set to SandBox", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.d("PayUMainActivity", "request code " + requestCode + " resultcode " + resultCode);
...
/*            *//**
           ...
           if (AppPreference.selectedTheme != -1) {
                PayUmoneyFlowManager.startPayUMoneyFlow(mPaymentParams,PayUMainActivity.this, AppPreference.selectedTheme,mAppPreference.isOverrideResultScreen());
            } else {
                PayUmoneyFlowManager.startPayUMoneyFlow(mPaymentParams,PayUMainActivity.this, R.style.AppTheme_default, mAppPreference.isOverrideResultScreen());
            }
    ...
    private class GetHashesFromServerTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String merchantHash) {
            ...
            if (merchantHash.isEmpty() || merchantHash.equals("")) {
                Toast.makeText(PayUMainActivity.this, "Could not generate hash", Toast.LENGTH_SHORT).show();
            } else {
                ...
                if (AppPreference.selectedTheme != -1) {
                    ...
                    PayUmoneyFlowManager.startPayUMoneyFlow(mPaymentParams, PayUMainActivity.this, R.style.AppTheme, mAppPreference.isOverrideResultScreen());
                }
            }
        }
    }
