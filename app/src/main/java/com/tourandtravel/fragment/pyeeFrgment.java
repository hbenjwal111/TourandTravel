...
/**
 * Created by himanshu on 12-10-2017.
 */

public class pyeeFrgment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View root = inflater.inflate(R.layout.pyee, null, false);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    pyeeFrgment.this.navigateToBaseActivity();
                } catch (Exception e) {
   ...
   private void navigateToBaseActivity() {
        ...
        merchantKey = "0MQaQP";
        String amount = "10";
        String email = "h.benjwal12@gmail.com";
